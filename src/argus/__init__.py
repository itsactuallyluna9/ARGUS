...
router = LlamaRouter(["100.119.149.15", "localhost", "100.100.137.64"], [8080 for _ in range(3)], ["glm-4.7-flash", "glm-4.7-flash", "nemotron-3-nano:4b"], max_tokens_list=[64000, 32000, 16384])

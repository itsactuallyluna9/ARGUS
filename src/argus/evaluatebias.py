...
if __name__ == "__main__":
    ...
    asyncio.run(accuracy_agent.evaluate_bias())

    logger.info(f"Political score: {accuracy_agent.political_score}")
    logger.info(f"Sensationalism score: {accuracy_agent.sensationalism_score}")
    logger.info(f"Emotional language score: {accuracy_agent.emotional_language_score}")
    logger.info(f"Political bias explanation: {accuracy_agent.political_bias_explanation}")
    logger.info(f"Sensationalism explanation: {accuracy_agent.sensationalism_explanation}")
    logger.info(f"Emotional language explanation: {accuracy_agent.emotional_language_explanation}")

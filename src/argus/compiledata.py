        ...
        self.fact_check_df = pd.DataFrame(
            {
                ...
                "sources": [json.loads(doc)['sources'] if "sources" in json.loads(doc) else json.loads(doc)['accuracy_sources'] + json.loads(doc)['completeness_sources'] for doc in fact_check_docs], # type: ignore
